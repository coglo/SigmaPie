...
def test_no_fro_fro_alldata():
    print(generate_nff(n = 10))
    print(generate_nff_bad(n = 10))
    evaluate_nff_words(generate_nff(n = 1000))
    evaluate_nff_words(generate_nff_bad(n = 1000))
